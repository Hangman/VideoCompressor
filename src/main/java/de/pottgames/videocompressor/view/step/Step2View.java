...
public class Step2View implements StepView {
    ...
    private VBox buildValidationPanel() {
        ...
        validationIconLabel.setStyle(Theme.FONT_LARGE_STYLE);
    ...
    private void showValidationResult(ValidationResult result) {
        if (result.valid() && result.warnings().isEmpty()) {
            validationIconLabel.setVisible(false);
            validationLabel.setVisible(false);
            validationPanel.setVisible(false);
        } else if (result.valid()) {
            // Valid but has warnings — amber
            validationIconLabel.setVisible(true);
            ...
            validationLabel.setStyle(Theme.TEXT_FILL_WARNING_STYLE);
            validationPanel.setStyle(
            ...
            validationLabel.setStyle(Theme.TEXT_FILL_DANGER_STYLE);
            validationPanel.setStyle(
